...
def get_listed_object(record):
    ...
    meta_detail = dict()
    meta_detail['description'] = record[1]
    ...
    data_obj = {
        ...
        "dissolution_date": "",
        "type": "",
        "crawler_name": "crawlers.custom_crawlers.kyb.insolvency.germany_kyb",
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        headline = new_string.replace("Selection indices: ", "").replace(":suspended ", "")
...
if __name__ == '__main__':
    ...
    source_type = "HTML"
    url= "https://www.boerse-frankfurt.de/news/da3c8d76-ca98-4dd0-a27b-6a885f1d689c"
