...
def get_listed_object(record):
    ...
    meta_detail = dict()
    meta_detail['panel_liquidator_and_firm'] = record[2].replace("'","''")
    meta_detail['address'] = record[3].replace("'","''")
    meta_detail['number_of_employees'] = record[4].replace("'","''")
    meta_detail['entitlement_payments'] = record[5].replace("'","''")
    meta_detail['dissolution_date'] = record[-1].replace("'","''")
    ...
    data_obj = {
        ...
        "dissolution_date": "",
        "type": record[1],
        "crawler_name": "crawlers.custom_crawlers.insolvency.australin_security_kyb",
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        for tr in trs:
            tds = tr.find_all('td')
            Company,ACN,Panel,State,Number_of_employees,Entitlements,Date = tds[0].text.strip(),tds[1].text.strip(),tds[2].text.strip(),tds[3].text.strip(),tds[4].text.strip(),tds[5].text.strip(),tds[6].text.strip()
            DATA.append([Company,ACN,Panel,State,Number_of_employees,Entitlements,Date])
...
if __name__ == '__main__':
    ...
    url = "https://asic.gov.au/regulatory-resources/insolvency/insolvency-for-employees/companies-wound-up-by-asic-in-2021-22-financial-year/"
