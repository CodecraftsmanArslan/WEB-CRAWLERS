...
def get_listed_object(record):
    ...
    meta_detail = dict()
    meta_detail['filing_type'] = record[1].replace("'","''")
    meta_detail['filing_date'] = record[2]
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        for tr in table.find_all('tr')[1:]:
            data = [td.find('a').text if 'href' in str(td).lower() else td.text for td in tr.find_all('td')]
            DATA.append(data)
            print(data)
...
if __name__ == '__main__':
    ...
    name = "PwC Canada"
    description = "PwC Canada is the Canadian member firm of PricewaterhouseCoopers (PwC), a global network of professional services firms that offer a wide range of services in the areas of audit, tax, consulting, and financial advisory."
    source_type = "HTML"
