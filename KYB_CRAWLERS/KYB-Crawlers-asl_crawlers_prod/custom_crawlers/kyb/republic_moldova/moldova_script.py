...
def remove_na_and_empty_addresses():
    try:
        ...
        select_query = "SELECT id, data FROM reports where countries='[\"Republic Of Moldova\"]' and data::text ilike '%Null%' or data::text ilike '%NONE%';"
                ...
                if key == 'addresses_detail':
                    ...
                    for entry in value:
                        ...
                        for inner_key, inner_value in entry.items():
                            cleaned_inner_value = inner_value.replace("NULL", " ").replace("null", " ").replace("  ", "").replace("None", " ").replace("none", " ").replace('NONE', ' ').strip() if isinstance(inner_value, str) else inner_value
                    ...
                    for entry in value:
                        ...
                        for inner_key, inner_value in entry.items():
                            if inner_key == 'data' and isinstance(inner_value, list):
                                ...
                                cleaned_inner_value = inner_value.replace("NONE", "") if isinstance(inner_value, str) else inner_value
                    ...
                    if isinstance(value, str):
                        cleaned_value = value.replace("NULL", " ").replace("null", " ").replace("  ", "").replace("None", " ").replace("none", " ").replace('NONE', ' ').strip()
