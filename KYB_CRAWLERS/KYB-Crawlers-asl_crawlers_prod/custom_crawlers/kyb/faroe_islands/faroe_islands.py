...
def get_listed_object(record):
    ...
    meta_detail = dict()
    meta_detail['source_url'] = record[-1]
    ...
    data_obj = {
        ...
        "registration_date": record[-2],
        "dissolution_date": "",
        "type": "",
        "crawler_name": "crawlers.custom_crawlers.kyb.faroe_islands.faroe_islands_kyb",
...
def prepare_data(record, category, country, entity_type, type_, name_, url_, description_):
    ...
    '''
    data_for_db = list()
    data_for_db.append(shortuuid.uuid(record[0]+'faroe_islands')) # entity_id
    ...
    try:
        ...
        while True:
            ...
            for tr in trs[1:]:
                ...
                DATA.append([Reg_no,Name,Date, pdf_url])
...
if __name__ == '__main__':
    '''
    Description: HTML Crawler for Faroe Islands
    '''
    name = 'Skráseting Føroya'
    description = "The Authority is responsible for the information about companies registered with the Authority. The Authority registers new companies and changes to already registered companies."
    entity_type = 'Company/ Organisation'
    source_type = 'HTML'
    countries = 'Faroe Islands'
    category = 'Official Registry'
    url = 'https://www.skraseting.fo/en/companies/search-companies?&name=_&page=1'
