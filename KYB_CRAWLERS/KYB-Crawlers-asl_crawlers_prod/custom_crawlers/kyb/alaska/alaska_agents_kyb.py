...
def get_listed_object(record):
    ...
    people_detail = {
            "name": record["OfficialFirstName"].replace("'","''")+''+record["OfficialLastOrEntityName"].replace("'","''"),
            "designation": record["OfficialTitle"].replace("'","''"),
            "meta_detail":{"person_registration_number" : str(record['OfficialEntityNumber']).replace("'","''")}
            }
    ...
    data_obj = {
        ...
        "crawler_name": "custom_crawlers.kyb.alaska.alaska_agents_kyb",
        "country_name": "Alaska",
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        df = pd.read_csv('.//kyb/alaska/input/AgentsDownload.csv')
...
if __name__ == '__main__':
    ...
    url = "https://www.commerce.alaska.gov/cbp/DBDownloads/AgentsDownload.csv"
