...
def get_listed_object(record):
    ...
    meta_detail = dict()
    meta_detail["naics_code"] = str(record["NaicsCode"]).replace("'","''") 
    meta_detail["description"] =  record["NaicsDescription"].replace("'","''")
    ...
    data_obj = {
        ...
        "dissolution_date": "",
        "type": record["Lob"],
        "crawler_name": "custom_crawlers.kyb.alaska.alaska_business_naics_kyb",
        "country_name": "Alaska",
...
def prepare_data(record, category, country, entity_type, type_, name_, url_, description_):
    ...
    '''
    data_for_db = list()
    data_for_db.append(shortuuid.uuid(str(record["LicenseNumber"])+record["NaicsCode"]+record['Lob']+record['BusinessName'])) # entity_id
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        df = pd.read_csv('.//kyb/alaska/input/BusinessNaicsDownload.CSV')
...
if __name__ == '__main__':
    ...
    url = "https://www.commerce.alaska.gov/cbp/DBDownloads/BusinessNaicsDownload.CSV"
