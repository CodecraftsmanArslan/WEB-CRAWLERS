...
def get_listed_object(record):
    ...
    meta_detail['compliance_status'] = record[1]
   
    meta_detail['defaulted_date'] = record[2]
    ...
    data_obj = {
        ...
        "dissolution_date": "",
        "type": "",
        "crawler_name": "crawlers.custom_crawlers.insolvency.pakistan.pakistan_stock_exchange_kyb2",
...
def prepare_data(record, category, country, entity_type, type_, name_, url_, description_):
    ...
    '''
    data_for_db = list()
    data_for_db.append(shortuuid.uuid(record[0]+ str(record[1])+record[2]+str(url)+ "pakistan_stock_exchange_kyb2")) # entity_id
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        p_tags = soup.find_all('p', class_=["PreviouslySegment"])
        ids = []
        ...
        base_url = "https://www.psx.com.pk/psx/resources-and-tools/test-Defaulting-Companies-Call?id={}&XID=c373cb1422ea375be0d8a1cf41ce715755401e17"
        for id in ids:
            dummy_data = dict()
            ...
            print("Response",res)
            DATA = []
            for compane_name in res['keytwo']:
            ...
            print(dummy_data)
            DATA=[dummy_data['company_name'],dummy_data['compliance_status'],dummy_data['defaulted_date']]  
