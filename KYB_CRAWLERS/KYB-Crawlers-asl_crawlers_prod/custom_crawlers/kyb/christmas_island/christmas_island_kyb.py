...
def get_listed_object(record):
    ...
    data_obj = {
        ...
        "crawler_name": "crawlers.custom_crawlers.kyb.christmas_island.christmas_island_kyb",
...
def prepare_data(record, category, country, entity_type, type_, name_, url_, description_):
    ...
    '''
    data_for_db = list()
    data_for_db.append(shortuuid.uuid(f"{record[3]}{record[4]}{record[5]}-christmas_island_kyb")) # entity_id
...
def get_records(source_type, entity_type, country, category, url, name, description):
    ...
    try:
        ...
        url_template = 'https://iot-businesses.com.au/business_directory/page/{page}/?search_keyword=%5BIOTChristmasIslandSearchKey%5D&directory_category&layout=list'
        ...
        for page in range(1, 16):
            ...
            for listing in listings:
                ...
                try:
                    description = listing.find('div', class_='ebd-listing-description').text.strip().replace("[IOTChristmasIslandSearchKey]","").replace("[IOTBothLocationSearchKey]","").replace("[IOTCocosKeelingIslandSearchKey]","")
                except:
                    description = ""
                try:
                ...
                try:
                    ...
                    website = ""
                data.append([name_, description, address, phone_num, email, website])
...
if __name__ == '__main__':
    '''
    Description: HTML Crawler for Christmas Island
    '''
    ...
    url = 'https://iot-businesses.com.au/business_directory/?search_keyword=%5BIOTChristmasIslandSearchKey%5D&directory_category&layout=list'
